...
UI = {
    "es": {
        ...
        "my_critiques_intro_available": "Te quedan {remaining} de {limit} críticas retroactivas para anuncios anteriores a tu membresía.",
        "my_critiques_intro_used": "Ya usaste tus {limit} críticas retroactivas o tienes historial previo.",
    ...
    "en": {
        ...
        "my_critiques_intro_available": "You have {remaining} of {limit} retroactive critiques left for ads that predate your membership.",
        "my_critiques_intro_used": "You've used all {limit} retroactive critiques or had prior critique history.",
